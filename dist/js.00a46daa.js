...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/util/fetch-data.js":[function(require,module,exports) {
"use strict";
...
var _fetchData = require("./util/fetch-data.js");
...
window.addEventListener('load', function (e) {
  ...
  */
  (0, _fetchData.httpGetRequest)("https://reqres.in/api/users").then(function (data) {
    console.log(data);
  });
});
},{"./util/fetch-data.js":"js/util/fetch-data.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
